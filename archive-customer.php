...
$alation_current_page = get_page_by_path('customers', OBJECT, 'page');
...
<div id="theme-page">
				...
				<?php
					...
					if( have_rows('slider', $alation_current_page) ):
						while ( have_rows('slider', $alation_current_page) ) : the_row();
							$link = alation_button_link( get_sub_field() );
				?>
	...
	<section class="band band-customers band-filterable">
		<div class="band-container">
			...
			<div class="filters">
				<?php
					...
					$taxonomies = get_object_taxonomies( 'customer', 'objects' );
			...
			<div class="items">
				<?php
					$items = new WP_Query( array( 'post_type' => 'customer', 'nopaging' => true ) );
				...
				?>
				<a href="<?php the_field('cta_link') ?>" class="item <?php echo implode(" ", $filterclasses); ?>">
					<div class="item-content">
						<div class="face-front">
							<div class="face-inner">
								...
								<div class="description"><?php the_field('front-description'); ?></div>
